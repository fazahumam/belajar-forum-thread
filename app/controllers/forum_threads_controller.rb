class ForumThreadsController < ApplicationController
  ...
  def index
    @thread = ForumThread.order(sticky_order: :asc).order(id: :desc).paginate(per_page: 4, page: params[:page])
  end
  ...
  def destroy
    ...
    @thread.destroy
    redirect_to root_path, notice: 'your thread have been deleted'
  end
